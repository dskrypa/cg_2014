...
/**
	...
	@param fps target frames per second for animation
...
void Env3D::setContents(void* o){
	contents = o;
}

void* Env3D::getContents(){
	return contents;
}

/**
	Determines whether or not a given point is within the bounds of this 3D environment
